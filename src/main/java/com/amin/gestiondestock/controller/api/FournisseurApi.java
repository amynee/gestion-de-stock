...
import static com.amin.gestiondestock.utils.Constants.FOURNISSEUR_ENDPOINT;
...
public interface FournisseurApi {
    ...
    @DeleteMapping(value = FOURNISSEUR_ENDPOINT + "/delete/{idFournisseur}", produces = MediaType.APPLICATION_JSON_VALUE)
